  ...
  return (
    <div className="m-8 space-y-8">
      ...
      <div className="flex space-x-4">
        <Button className="bg-red-500 text-white font-bold px-8 py-3 rounded hover:bg-red-400">
          応募する
        </Button>
      ...
      {/* 画像 */}
      <div className="space-y-2">
        <img className="w-full max-w-md rounded"
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-end">
          <Button className="bg-blue-500 text-white font-bold px-6 py-2 rounded hover:bg-blue-400">
            投稿
          </Button>
        </div>
